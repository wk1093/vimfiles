...
sync_plugin "https://github.com/lifepillar/vim-solarized8.git" "$VENDOR_DIR/solarized8"
...
sync_plugin "https://github.com/lervag/vimtex" "$PACK_DIR/vimtex"
sync_plugin "https://github.com/SirVer/ultisnips" "$PACK_DIR/ultisnips"
